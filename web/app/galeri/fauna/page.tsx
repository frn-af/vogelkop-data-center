...
export const metadata: Metadata = {
  title: "Galeri Fauna",
  description: "Koleksi satwa unik dan endemik di wilayah Papua Barat Daya.",
};

export default function FaunaPage() {
  const speciesList = getSpeciesByType("fauna");
  ...
  return (
    <div className="mx-auto max-w-7xl px-[var(--padding-section-x)] py-8">
      ...
      <div className="mt-8 flex flex-col gap-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Fauna Papua Barat Daya</h1>
          <p className="mt-2 text-muted-foreground">
            Menampilkan keanekaragaman satwa liar yang menghuni berbagai ekosistem di wilayah Semenanjung Kepala Burung.
          </p>
        </div>
